 ...
 * This file demonstrates how to integrate Driveromen with a web frontend
 */

// For React/Vue/Angular applications
export class DriveromenClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DriveromenClient(provider, contractAddress);
